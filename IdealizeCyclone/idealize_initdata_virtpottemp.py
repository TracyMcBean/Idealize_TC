...
data_out_file     = "/scratch/usr/bekthkis/ICON_08_2019/Fiona2016/init_data/virtpottemp_idealized.nc"
...
plt.figure()
plt.tripcolor(ds.clon, ds.clat, ds.theta_v.isel(time = 0, height=49))
plt.colorbar()
plt.show()
