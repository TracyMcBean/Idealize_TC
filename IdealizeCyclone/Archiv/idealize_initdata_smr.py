...
data_out_file     = "/scratch/usr/bekthkis/ICON_08_2019/Fiona2016/init_data/smr_idealized.nc"
...
ft_variables = {'density': False, 'virt pot temp': False , 'pressure':False, \
                ...
                'rain mixing ratio': False, 'snow mixing ratio': True }
#------------------------------------------------------------------------------
...
if ft_variables['snow mixing ratio']:
    ...
    ideal_data_da = ft_var(ds.qs[0], center, r_rad, nlev, lev_start, 'Humidity/snow_mr', 'qs', height, create_plot=True)
...
'''
plt.figure()
plt.tripcolor(ds.clon, ds.clat, ds.rho.isel(time = 0, height=49))
plt.colorbar()
plt.show()
'''
